...
def get_images(q = "", region = "full", size = "full", rotation = "0", quality = "default", p_form = "jpg", page = 1, page_size = 100):
    ...
    size: obj
        Specify the size of the image returned (i.e 100,100)
    rotation: obj
    ...
    Examples
    --------
    >>> get_images("Barbie", size = ("600,600"))
    What kind of search were you looking to do?
    Type 1 to search generally
    Type 2 to search for a certain type of object (i.e book, painting)
    Type 3 to search for a certain material or technique (i.e silver as a material or etching as a technique)
    ...
    https://framemark.vam.ac.uk/collections/2006AE7822/full/600,600/0/default.jpg
    https://framemark.vam.ac.uk/collections/2006AN0713/full/600,600/0/default.jpg
    https://framemark.vam.ac.uk/collections/2014GX5584/full/600,600/0/default.jpg
    https://framemark.vam.ac.buk/collections/2016HY8414/full/600,600/0/default.jpg
    https://framemark.vam.ac.uk/collections/2006BF0421/full/600,600/0/default.jpg
